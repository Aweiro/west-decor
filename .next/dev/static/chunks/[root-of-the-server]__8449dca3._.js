...
"[project]/src/pages/prisma/FavoritesPage.module.scss [client] (css module)", ((__turbopack_context__) => {

__turbopack_context__.v({
  "container": "FavoritesPage-module-scss-module__HHNhsq__container",
  "favorites__empty": "FavoritesPage-module-scss-module__HHNhsq__favorites__empty",
});
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Breadcrumbs$2f$Breadcrumbs$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/Breadcrumbs/Breadcrumbs.tsx [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$prisma$2f$FavoritesPage$2e$module$2e$scss__$5b$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/pages/prisma/FavoritesPage.module.scss [client] (css module)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProductCard$2f$index$2e$ts__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/components/ProductCard/index.ts [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProductCard$2f$ProductCard$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ProductCard/ProductCard.tsx [client] (ecmascript)");
...
const Prisma = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setLoading(true);
        if (!selectedFile) return alert('Вибери файл');
        const imageUrls = await uploadImages(selectedFile);
        const payload = {
            itemId: form.itemId,
            category: form.category,
            name: form.name,
            fullPrice: Number(form.price) || 0,
            price: Number(form.price) || 0,
            screen: form.screen || '',
            capacity: form.screen || '',
            color: form.color || '',
            ram: form.ram || '',
            year: form.year || 2000,
            image: imageUrls[0]
        ...
        if (form.category) {
            payload.details = {
                ...
                processor: 'unknown',
                // zoom: 'unknown',
                capacity: form.capacityAvailable.split(',').map((s)=>s.trim()) || [],
                priceRegular: Number(form.price) || 0,
                priceDiscount: Number(form.price) || 0,
                color: form.color || '',
                images: imageUrls,
                cell: [],
                capacityAvailable: form.capacityAvailable.split(',').map((s)=>s.trim()) || [],
                colorsAvailable: form.colorsAvailable.split(',').map((s)=>s.trim()) || [],
                description: [
                    {
                        title: 'Always-On Retina display',
                        text: [
                            'A transformative triple-camera system that adds tons of capability without complexity.An unprecedented leap in battery life.',
                            'And a mind-blowing chip that doubles down on machine learning and pushes the boundaries of what a smartphone can do. Welcome to the first iPhone powerful enough to be called Pro.'
                        ]
                    }
                ],
                namespaceId: ''
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$prisma$2f$FavoritesPage$2e$module$2e$scss__$5b$client$5d$__$28$css__module$29$__["default"].productsGrid,
                children: [
                    !loading && products.map((product)=>// <div key={product.id} className={styles.productCard}>
                        //   <h3>{product.name}</h3>
                        //   <h3>{product.productId}</h3>
                        //   <p>${product.price}</p>
                        //   <p>${product.category}</p>
                        // </div>
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProductCard$2f$ProductCard$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["ProductCard"], {
                            product: product
                        }, void 0, false, {
                            fileName: "[project]/src/pages/prisma/index.tsx",
                            lineNumber: 188,
...
_s(Prisma, "CMOIjzkfKyByN6BGmrJa/o2AG3s=");
_c = Prisma;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8449dca3._.js.map